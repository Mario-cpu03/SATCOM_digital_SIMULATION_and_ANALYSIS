...
headerscc = {'meanBER_cc', 'meanTRHOUGHPUT_cc', 'meanPER_cc', 'SNRpercomm_cc', 'meanAWGN_POWER_cc', 'meanUP_LOSS_cc', 'meanDOWN_LOSS_cc', 'meanTEMPERATURE_cc', 'meanWV_DENSITY_cc', 'meanUP_THERMAL_POWER_cc', 'meanDW_THERMAL_POWER_cc'};
headersnc = {'meanBER_nc', 'meanTRHOUGHPUT_nc', 'meanPER_nc', 'SNRpercomm_nc', 'meanAWGN_POWER_nc', 'meanUP_LOSS_nc', 'meanDOWN_LOSS_nc', 'meanTEMPERATURE_nc', 'meanWV_DENSITY_nc', 'meanUP_THERMAL_POWER_nc', 'meanDW_THERMAL_POWER_nc'};
