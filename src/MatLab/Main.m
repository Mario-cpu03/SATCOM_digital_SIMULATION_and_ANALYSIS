...
fprintf('\n*************\n');
[BERNoCode, THROUGHPUTNoCode, PERNoCode, AWGNNoCode, ATMLOSSupNoCode, ATMLOSSdwNoCode, TEMPERATURENoCode, DENSITYNoCode, THERMALNOISENoCode, SNRNoCode] = NoChannelCod(MonteCarlo, NumMessages, BitTx, BitRx, BitAck);
disp(BERNoCode)
...
fprintf('\n*************\n');
[BERCode, THROUGHPUTCode, PERCode, AWGNCode, ATMLOSSupCode, ATMLOSSdwCode, TEMPERATURECode, DENSITYCode, THERMALNOISECode, SNRCode] = ChannelCod(MonteCarlo, NumMessages, BitTx, BitRx, BitAck);
...
PerformanceImprovGraph(mean(BERNoCode), mean(BERCode) ...
    ...
    , mean(THERMALNOISENoCode), mean(THERMALNOISECode) ...
...
DataWriting(BERNoCode, BERCode ...
    ...
    , THERMALNOISENoCode, THERMALNOISECode ...
    , SNRNoCode, SNRCode);
fprintf('\n*************\n');
