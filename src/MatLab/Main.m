...
fprintf('\n*************\n');
[BERNoCode, THROUGHPUTNoCode, PERNoCode, AWGNNoCode, ATMLOSSupNoCode, ATMLOSSdwNoCode, TEMPERATURENoCode, DENSITYNoCode, THERMALNOISENoCode] = NoChannelCod(MonteCarlo, NumMessages, BitTx, BitRx, BitAck);
...
fprintf('\n*************\n');
[BERCode, THROUGHPUTCode, PERCode, AWGNCode, ATMLOSSupCode, ATMLOSSdwCode, TEMPERATURECode, DENSITYCode, THERMALNOISECode] = ChannelCod(MonteCarlo, NumMessages, BitTx, BitRx, BitAck);
